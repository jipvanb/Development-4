...
def home():
    ...
    if request.cookies.get('access_token'):
        ...
        print(logged['id'], "me")
        args = {"id": logged['id']}
        qryR = ''' SELECT  photo, customer_id, reservation_date, date_of_reservation, cars.id,  year, color, cars.name as car_name, type.name as type_name FROM reservations LEFT JOIN cars on cars.id = reservations.cars_id LEFT JOIN type ON type.id = cars.type_id WHERE customer_id = :id LIMIT 3'''
